    ...
    return (
        <div className="min-h-screen bg-[#0B0E12] text-white flex flex-col items-center justify-center p-4">
            <div className="max-w-md w-full bg-[#11141D] border border-red-900/50 rounded-xl p-6 space-y-4">
                <h2 className="text-xl font-bold text-red-500">System Failure</h2>
                ...
                <div className="flex gap-2">
                    ...
                    <Button onClick={() => window.location.href = '/clans'} className="w-full bg-zinc-800 hover:bg-zinc-700">
                        Abort (Return to List)
                    </Button>
                </div>
            </div>
        </div>
