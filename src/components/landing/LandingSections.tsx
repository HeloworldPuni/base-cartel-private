            ...
            <div className="relative z-10 flex flex-col items-center gap-6 max-w-4xl">
                ...
                <div className="mt-8">
                    {isConnected ? (
                        ...
                        <Link href="/login" className="group relative px-8 py-4 bg-white text-black font-black text-xl rounded-full overflow-hidden hover:scale-105 transition-transform duration-300 shadow-[0_0_40px_rgba(255,255,255,0.3)] inline-block">
                            <span className="relative z-10">{LANDING_CONTENT.hero.cta}</span>
                            <div className="absolute inset-0 bg-gradient-to-r from-[#3DFF72] to-[#4FF0E6] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                        </Link>
                    )}
    ...
    return (
        <footer className="py-12 border-t border-white/5 bg-zinc-950/50 text-center">
            ...
            <div className="flex justify-center gap-8 mb-8">
                <a href="#" className="text-zinc-500 hover:text-white hover:scale-110 transition-all duration-300" aria-label="Abosultely Not Twitter">
                    <IconX className="w-5 h-5" />
                </a>
                <a href="#" className="text-zinc-500 hover:text-[#0052FF] hover:scale-110 transition-all duration-300" aria-label="Base">
                    <IconBase className="w-6 h-6" />
                </a>
                <a href="#" className="text-zinc-500 hover:text-[#855DCD] hover:scale-110 transition-all duration-300" aria-label="Farcaster">
