...
export default function CartelDashboard({ address }: CartelDashboardProps) {
    ...
    return (
        <div className="desktop-body w-full">
            {/* APP CONTAINER - Fits like a mobile phone on desktop */}
            <div className="min-h-screen bg-[#0B0E12] text-white p-4 space-y-6 w-full max-w-md relative overflow-hidden shadow-2xl border-x border-zinc-800/50">
